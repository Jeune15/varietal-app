...
const CuppingView: React.FC<Props> = ({ stocks }) => {
  ...
  const renderScale = (label: string, intensityField: keyof CuppingForm, notesField: keyof CuppingForm) => (
    <div className="border border-stone-200 p-4 space-y-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] font-bold uppercase tracking-widest text-stone-400">Intensidad</span>
          </div>
        </div>
      ...
      <textarea
        ...
        placeholder="Notas..."
        className="w-full mt-2 border border-stone-200 px-3 py-2 text-xs outline-none focus:border-black resize-none h-16"
      />
    </div>
  );
  ...
  return (
    <div className="space-y-10 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-black pb-6">
        <div className="space-y-1">
          <h2 className="text-3xl font-black uppercase tracking-tighter text-black">Catación</h2>
          <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-stone-500">
            Sistema descriptivo de evaluación sensorial
          </p>
        </div>
        <div className="flex flex-col items-stretch gap-3 text-xs text-stone-600 md:items-end">
      ...
      {!canEdit && activeTab === 'form' && (
        <div className="border border-dashed border-stone-300 p-10 text-center text-sm text-stone-500 font-bold uppercase tracking-widest">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full border border-stone-200 px-3 py-2 text-sm font-medium outline-none focus:border-black"
                  >
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full border border-stone-200 px-3 py-2 text-sm outline-none focus:border-black"
      ...
      {selectedSessionForSummary && (
        <div
          className="fixed inset-0 bg-stone-900/40 backdrop-blur-sm z-[160] flex items-center justify-center p-4"
          onClick={() => setSelectedSessionForSummary(null)}
        >
          <div
            className="bg-white w-full max-w-6xl max-h-[90vh] overflow-y-auto border border-black shadow-2xl"
            onClick={e => e.stopPropagation()}
          >
            <div className="px-8 py-6 border-b border-stone-200 flex items-center justify-between bg-black text-white">
              <div className="space-y-1">
              ...
              <div className="flex flex-col items-end gap-2">
                <span className="text-[10px] font-bold uppercase tracking-[0.25em] text-stone-300">
