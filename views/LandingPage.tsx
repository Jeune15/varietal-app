...
const LandingPage: React.FC<Props> = ({ onMenuOpen }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4 sm:px-6">
      <div className="w-full max-w-5xl flex flex-col items-start md:items-start justify-center">
        <div className="space-y-0 text-left">
          ...
          <div className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-black uppercase tracking-widest md:tracking-[0.1em] leading-none md:leading-[0.9] break-words hyphens-auto">
