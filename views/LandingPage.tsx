...
const LandingPage: React.FC<Props> = ({ onMenuOpen }) => {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-5xl flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
        <div className="space-y-0 text-left">
          ...
          <p className="text-xs md:text-base font-serif italic text-black tracking-[0.2em] md:tracking-[0.3em] mt-4 md:mt-6 ml-1">
            since 2022
          </p>
        </div>
        ...
        <button
          onClick={onMenuOpen}
          className="self-start md:self-auto inline-flex items-center gap-2 px-5 py-3 border border-black text-black text-xs font-bold uppercase tracking-widest hover:bg-black hover:text-white transition-colors"
        >
          <span>Menú</span>
