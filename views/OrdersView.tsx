...
const OrderCard: React.FC<OrderCardProps> = ({ order, onNext, onPrev, onDelete, isFinal }) => (
  <div className="bg-white p-6 border border-stone-200 hover:border-black transition-all group relative flex flex-col gap-4">
    ...
    <div className="flex justify-between items-start">
      <div>
        <span className="text-[9px] font-bold text-stone-400 uppercase tracking-widest">{order.variety}</span>
    ...
    <div className="flex items-center gap-2 text-xs text-stone-600 font-medium border-t border-stone-100 pt-3">
      <span className="font-bold">{order.quantityKg} Kg</span>
        ...
        >
          ...
          >
            <div className="bg-black p-8 text-white flex justify-between items-start">
              ...
              <button onClick={() => setShowModal(false)} className="text-white hover:text-stone-300 transition-colors">
                <X className="w-6 h-6" />
              </button>
            </div>
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.2em]">Variedad</label>
                    <input 
                      type="text" 
                      required 
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.2em]">Ingreso</label>
                    <input 
                      type="date" 
                      required 
                      className="w-full py-3 bg-white border-b border-stone-200 focus:border-black outline-none text-xs font-mono transition-colors" 
                      value={formData.entryDate} 
                      onChange={e => setFormData({...formData, entryDate: e.target.value})} 
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.2em]">Entrega</label>
                    <input 
                      type="date" 
                      required 
                      className="w-full py-3 bg-white border-b border-stone-200 focus:border-black outline-none text-xs font-mono transition-colors" 
